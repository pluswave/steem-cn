...
我们采用了若干关键原则来指导Steem的设计。最重要的原则是向企业提供内容的每个人应当收到企业按比例提供的所有权、付款或债务作为回报。这一原则与应用于所有创业公司的原则相同，因为都是在创立初期和随后的融资过程中分配股份。
...
5、工作机会，内容是向其他成员提供以上服务。

Steem有目的地重组经济激励机制，有可能为所有的关系人提供一个平台，比先前社交媒体和加密货币平台更公允、更兼容并包。本文将对现有的经济刺激机制进行探讨，展示了Steem的激励方法也许能为大多数参与者带来更好的收益。

## 辨别贡献

Steem的设计宗旨是扫清目前的主要障碍，以便应用和货币化基于社交媒体的经济形式。我们坚信，用于壮大主要社交媒体平台的技术同样可以成功引导加密货币。基于加密货币的经济激励机制可以显著地促进新社交媒体平台的发展。我们相信，加密货币与社交媒体之间的协同，可为Steem提供一个强大的市场优势。

Steem面临的挑战是推衍出对个人贡献内容进行打分的算法，该算法对每一个贡献内容主观价值的公平评估，能够让大多数社区成员一致认同。在一个完美的世界里，社区成员相互合作，对彼此的贡献内容进行评定，得出公正的报酬。而在现实世界中，必须设计算法来抵御某些人故意操纵获益。任何普遍滥用评分系统的行为，都可能造成社区成员失去对经济体系公平性的信任。

现有平台的运行原则是一人一票。这形成一个可以通过女巫攻击操纵排名的环境，服务供应商必须积极识别和拦截舞弊者。尽管仅有的回报是网站流量或言论审查，已经有人在企图操纵Reddit、Facebook和Twitter的评分算法。

Steem平台上帐户的基本单位是STEEM，一种加密电子货币的代币。Steem的运行基础是一STEEM一票。在此模式之下，根据帐户余额进行计量，为平台提供内容最多的个人对贡献内容如何评分拥有最大的影响。此外，Steem致力于多年行权计划，仅允许拥有STEEM的成员投票。在此模式之下，成员拥有足够的财务激励，为实现STEEM长期价值最大化而投票。

Steem的设计基于一个相对简单的概念：每个人向社区提供有意义的贡献都应该得到相应的价值激励。人们只有在提供有意义的贡献内容时得到认可，才会继续做贡献，社区才能得到发展。社区内部的交换不平衡是不可持续的，最终付出的人对获取的人感到厌倦，从而脱离社区。

问题在于建立一个系统，能够识别什么是需要的贡献内容以及其相对价值，并且能够扩展到无数成员的规模。

对贡献内容进行评估和提供奖励的一个可靠体系是自由市场。自由市场可以看成是一个单独的社区，每个人彼此进行交易，通过收益与损失确定奖励。市场体系能够奖励那些向其他人提供价值的人，处罚那些消耗超过创造价值的人。自由市场支持各种货币，人们发现钱只是易于交换的一种中间物品。

因为自由市场被证实是可靠的，这就吸引人们尝试创造一个自由市场，内容消费者直接支付给内容生产者。但是，对于内容生产和传播来说，直接付款太过低效而不现实。大多数内容的价值太低(相对于认知、财务和机会成本)，很少有读者愿意直接给钱。丰富的免费替代方案意味着“付费门槛”将把读者赶往其他地方。也存在过一些读者向作者按照文章小额付款的尝试，但并没有大范围流行。

Steem的设计目标，是通过改变计算方法，实现各种贡献的有效小额支付。读者无须决定是否要从自己的口袋里向其他人付款，而是可以对内容投赞成或者反对票，由Steem根据投票情况决定个人奖励。这意味着人们使用业已熟悉的、广泛使用的交流方法，而无须面临传统小额支付和打赏平台中的认知、财务和机会成本问题。

来自社区成员的投票信息，对于Steem平台向贡献者准确地分配报酬十分关键。因此投票可以视为一项关键的贡献内容，本身就值得奖励。有些平台，例如Slashdot，采用变化审核[3]作为对诚信审核者进行排名和提供回报的方式。Steem选择向那些为内容的传播做出主要贡献的会员提供奖励，对投票人的奖励额度与向内容生产者支付的最终报酬成比例。

Steem还使用客观指标识别和奖励其他形式的贡献。这些形式包括交易确认、工作量证明挖矿、流动性，以及报告舞弊者。

\newpage

# 贡献方式

本节概要说明了Steem背后的概念以及如何奖励那些向Steem社区提供有意义的、可计量贡献内容的会员。

## 资本投入

社区可用来吸引资本的有两个方面：债务和所有权。购买所有权的会员在社区得到发展时获得利润，但在社区收缩时面临损失。购买债务的会员能够得到有保证的定量利益，但不能获得社区发展实现的任何利润。对于社区发展和货币价值，两种资本投入方式都是宝贵的。此外，持有所有权有两种方式：变现和行权。所有权行权得到一个长期的承诺，在短期内不能出售。
...
SP结余是不可转让、不可分割的，通过自动递归转换请求的除外。这意味着SP不能轻易的在加密货币交易所交易。

拥有SP是能够对内容投支持和反对票的必要条件。这意味着SP是在Steem平台内部向持有人授予专有权力的代币。
...
Steem Dollar简写为SMD。创建SMD有如下几个要求:综合可靠的价格输入、防止滥用的规则和流动性。提供可靠的价格输入涉及三个要素：不正确输入影响最小化、不正确输入成本最大化和时效影响最小化。

### 欺骗性输入最小化

SP持有人推选出特定人群发布价格输入。我们假定，对价格输入有长期兴趣的人信任这些被选举出来的人们。通过向当选者付款，Steam创造了市场竞争：在Steem平台中，人们通过市场竞争，博得发布价格输入的权力。价格输入发布者获得的报酬越多，他们就会因发布假信息遭受到更多损失。

假设有一组受到信任的当选输入提供者，可以用把各个输入的中值作为实际转换的价格。这样，如果有少数的个人发布异常输入值，他们对实际中值的影响极小，而异常值本身却能影响他们的声望。

即使所有输入提供者都是诚信的，可能存在一种情况，大多数的输入提供者受到失控的事件影响。Steem网络设计容许有短期的不好的价格输入，同时社区积极工作纠正问题。例如，可能需要花时间来纠正短期市场操纵。市场操纵是维持长期稳定的障碍，会造成巨大的代价。另一个例子是中央交易所失效或交易所发布了不好的数据。

Steem利用一个星期内的中值价格消除短期价格波动的影响。每小时整点对输入发布的中值进行取样。

只要价格输入的不良影响持续时间小于移动中值时间窗口的一半，对转换价格的影响就是极小的。如果输入受到影响，网络参与者还有机会在受影响输入对实际转换价格发生影响前投票剔除不良输入提供者。也许更重要的是，这给输入提供者提供了一个机会，能够在输入开始对价格发生影响之前发现和纠正问题。

在一周时间窗口中，社区成员拥有三天半来响应即将到来的任何问题。
...
如果人们可以自由地进行双向交易，那么交易者可以利用区块链转换速度进行大量交易而不改变其价格。那些能够看到价格大大抬高的交易者将以高价转换成SMD（当时是最冒险的），然后等到纠正价格之后再转换回来。Steem协议保护社区避免发生这种类型的舞弊，仅允许人们从SMD向STEEM转换，禁止反向操作。

区块链决定如何、何时生成SMD以及谁将获得生成的SMD。这能够维持稳定的SMD生成速度，消除大多数的舞弊途径。

### 流动性

仅仅因为SMD可以在合理的时间内按合理的价格转换为STEEM现金价值，并不意味着可以把它看成是可靠的现金替代品。这些资产需要一个流动性的市场，才能实现STEEM和SMD之间的即时转换。区块链必须采取的阻止滥用的措施导致了可兑换现金的质量下降。为了补偿这一损失，区块链可以给予流动性供应商固定成本的回报奖励。鉴于操纵和滥用导致的损失可能无限大，可以设置固定的成本刺激流动性。

流动性供应商购买并出售SMD和STEEM。他们承担大部分的短期价格波动风险和长期价格输入风险，向其余的市场参与者提供优质的、流动性极佳的市场，人们可以在这个市场中进行交易。

Steem拥有SMD和STEEM之间的区块链上市场。用户可以通过向这一市场的交易双方提供流动性获得回报。区块链利用简单的算法对每一个用户的流动性供给和消耗进行排名。

如果用户的委托交易停留时间至少达到1分钟，并且最终得到执行，则用户被视为流动性供应商。如果委托在得到执行之前撤销，那么该用户没有资格获得流动性报酬。

有资格的用户必须在两端提供流动性，同时必须始终提供流动性。评分算法如下：

流动性点数=净报价量×净询价量

每个小时，拥有最多流动性点数的帐户获得1200 STEEM，然后其提现点数归零。一周以内没有赚取任何流动性点数的帐户，其点数也归零。这意味着无论你是提供大量流动性还是长时间少量的流动性，你都会获得成一部分奖励金额。无论净报价量或净询价量为负数，那么流动性点数视为0。
...
共识是社区对信息单元普遍认可、明确同意的方法。社会为达成有关谁拥有什么的共识开发了很多算法。世界上每个政府都是一个基本的共识算法单元，全体人员同意遵守组织中供奉的某一个规则集合。政府设立法院、法官和陪审员解释主观上的事实，得出最后的决定。在大部分时候，人们会遵守决定，即使这是错误的。

加密货币采用的算法是提供一种达成共识的更好方法。公众总帐目中记录了来自个人的密码签名声明，建立全球事件的绝对序列。确定性的计算机算法能因此处理这一总帐目，得出一个普遍接受的结论。只要社区的成员对处理算法的意见一致，算法的结果就是权威性的。

主要考虑的因素是确定允许哪些声明记录到公众记录中。系统应当专门设计用于实现网络审查可能性最小化。对公众总帐目的网络审查与阻止某人对选择进行投票类似。在两种情况下，都能防止个体对全球共识发生影响。

## Steem共识

在概念上，Steem采用的共识算法与全世界公司采用的共识算法类似。对Steem未来价值拥有既得利益的人们投票选出负责将声明纳入公众记录的个人。投票权重与每一个个体的既得利益成比例。
